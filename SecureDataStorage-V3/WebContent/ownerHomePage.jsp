...
<div id="navbar_link">
<ul>
	<li class="currentpage"><a href="ownerHomePage.jsp">OWNER HOME PAGE</a></li>
...
<p><h1></>Data Owner</h1></p>
<p><h3>&nbsp &nbsp &nbsp A data owner is an authorized person who stores the files, updates, deletes it, and control some functions like encryption and grant access for data users.</h3></p>
</br>
</br>
</br>
</br>
