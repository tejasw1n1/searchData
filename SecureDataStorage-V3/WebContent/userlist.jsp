...
<script type="text/javascript">
	function deleteFile(userId){
		...
		window.location.href="/SecureDataStorage-V3/DeleteUser?userId="+userId;
	}
</script>
...
<ul>
	...
	<li><a href="OwnerDetailsForServer">VIEW DATA OWNERS LISTS</a></li>
	<li class="currentpage"><a href="UserDetailsForServer">VIEW DATA USERS LISTS</a></li>
