...
<table align="center" width="1020">
	<tr>
		...
		<table align="center" style="width: 581px; height: 198px">
			<div align="center" class="paragraping1">
				<font color="#006600"size="3"> One Time Password</font>
			</div>
	<!-- 		<tr>
			...
			<tr>
					<td><img src="img/key1.png" /></td>
					<td><font face="Courier New" size="+1"><strong>Secrete Key</strong></font></td>
			   		<td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="secretKey" class="b" /></td>
			</tr>
			<input type="hidden" name="un" value="<%= request.getAttribute("userName") %>" />
			<input type="hidden" name="pass" value="<%= request.getAttribute("password") %>" />
			...
			<!-- 		<button type="getKey" name="key" value="" class="getKey">Get Key</button> -->
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
