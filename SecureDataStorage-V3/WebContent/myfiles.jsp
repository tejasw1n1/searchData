...
<script type="text/javascript">
	function deleteFile(fileId){
		...
		window.location.href="/SecureDataStorage-V3/Delete?fileId="+fileId;
	}
	
	function modifyFile(fileId){
		//window.transfer("modify.jsp");
		//console.log("fileId"+fileId);
		window.location.href="/SecureDataStorage-V3/Modify?fileId="+fileId;
	}
</script>
</head>
<body>
...
<ul>
	...
	<li><a href="senderwelcome.jsp">UPLOAD</a></li>
	<li class="currentpage"><a href="MyFiles">MY FILES</a></li>
			...
			<tbody>
				 <c:forEach items="${files}" var="file">
					<tr>
						...
						<td>${file.rank}</td>
						<td><button name="Modify" onclick="modifyFile(${file.fileid})">Modify</button></td>
						<td><button name="Delete" onclick="deleteFile(${file.fileid})">Delete</button></td>
					</tr>
				</c:forEach> 
			</tbody>
		</table>
