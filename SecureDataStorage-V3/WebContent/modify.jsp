...
<ul>
	...
	<li class="currentpage"><a href="/SecureDataStorage-V3/modify.jsp">Modify</a></li>
...
<div id="innerwrapper">
	<form action="UploadModifyedData" method="post" style="padding: 10px; margin: 10px; text-align: left;">
		Modify</br></br>
		<textarea type="text" name="modifyFile" align="middle" rows="30" cols="30"> ${content}</textarea>
		</br>
		</br>
		<input type="hidden" name="fileid" value="${fileid}" />
		<button align="left" style="width: 100px; name="submit" padding: 10px; margin: 10px; onclick=" ">Submit</button>
	</form>
</div>
<div id="footer">
